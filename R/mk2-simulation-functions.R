...
## This script contains definitions for functions required to produce a dataset containing simulation results
...
## The job of each function is described more specifically below:
